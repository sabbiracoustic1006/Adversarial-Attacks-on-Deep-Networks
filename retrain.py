# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 17:18:45 2022
...
def train(args):
    ...
    train_dl, valid_dl, test_dl = get_dataloaders(batch_size, args.dataset, retraining=True)
    ...
    model.load_state_dict(torch.load(f'saved_models/{args.model}_{args.dataset}.pth'))
    ...
    for epoch_i in range(n_epochs):         
        ...
        test_FGSM_new(model, test_dl, 0.004)   
        ...
        if valid_acc > best_acc:
            torch.save(model.state_dict(), f'saved_models/retrained_{args.model}_{args.dataset}.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_epochs', default=5, type=int, help='batch size to be used for training')
