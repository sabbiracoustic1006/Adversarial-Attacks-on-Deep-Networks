# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 15:18:40 2022
...
def get_plots():
    ...
    plt.legend()
    plt.title(f'Attacks on {args.dataset}')
    
    os.makedirs(f'plots/{args.dataset}', exist_ok=True)
    
    plt.savefig(f'plots/{args.dataset}/exp1.PNG')
...
if __name__ == '__main__':
    ...
    np.save(f'attack_results/{args.dataset}/exp1.npy', {'FGSM': FGSM_accs, 'IFGSM': IFGSM_accs,
                                                        'MIFGSM': MIFGSM_accs})
